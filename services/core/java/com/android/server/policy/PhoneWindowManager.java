...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private String mRingerToggleChord = NUSANTARA_VOLUME_HUSH_OFF;
    ...
    private void handleRingerChordGesture() {
        if (mRingerToggleChord == null ||
                mRingerToggleChord.equals(NUSANTARA_VOLUME_HUSH_OFF)) return;
                    ...
                    boolean preCondition() {
                        switch (mPowerVolUpBehavior) {
                            case POWER_VOLUME_UP_BEHAVIOR_MUTE:
                                return mRingerToggleChord != NUSANTARA_VOLUME_HUSH_OFF;
                            default:
                                return true;
                        }
                    }
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (!mContext.getResources()
                ...
                mRingerToggleChord = Settings.Secure.NUSANTARA_VOLUME_HUSH_OFF;
            }
