        ...
        VALIDATORS.put(Secure.VOLUME_HUSH_GESTURE,
                new Validator() {
                    ...
                    public boolean validate(String value) {
                        ...
                        if (value.equals(Secure.NUSANTARA_VOLUME_HUSH_OFF))
                            return true;
                        String[] args = value.split(",", 0);
                        for (String str : args) {
                            if (!str.equals(Secure.NUSANTARA_VOLUME_HUSH_NORMAL) ||
                                !str.equals(Secure.NUSANTARA_VOLUME_HUSH_MUTE) ||
                                !str.equals(Secure.NUSANTARA_VOLUME_HUSH_VIBRATE)
                            ) return false;
                        }
                        return true;
                    }
